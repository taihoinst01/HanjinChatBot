...
namespace HanjinChatBot
{
    ...
    public class MessagesController : ApiController
    {
        ...
        static public string DeliveryList = apiUrl + "ipcc_api.get_wbls";                 //택배목록(수하인)
        static public string SendDeliveryList = apiUrl + "ipcc_api.get_snd_wbls";                 //택배목록(송하인)
        ...
        public async Task<HttpResponseMessage> Post([FromBody] Activity activity)
        {
            ...
            if (activity.Type == ActivityTypes.ConversationUpdate && activity.MembersAdded.Any(m => m.Id == activity.Recipient.Id))
            {
                ...
                for (int i = 0; i < confAPIList.Count; i++)
                {
                    switch (confAPIList[i].apiName)
                    {
                        case "DELIVERYLIST":
                            ...
                            break;
                        case "SENDDELIVERYLIST":
                            SendDeliveryList = confAPIList[i].apiUrl;
                            break;
                ...
                DButil.HistoryLog("* activity.Type : " + activity.Type);
            ...
            else if (activity.Type == ActivityTypes.Message)
            {
                ...
                //if (activity.Text.Contains("tel:"))
                {
                    ...
                    if (telMessage.Contains("hsc:") && checkTelNumber > 5)
                    {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            */
                            ...
                            else if (apiActiveText.Equals("예약") || apiActiveText.Equals("개인택배"))
                            {
                                apiIntent = "F_예약";
                                db.UserCheckUpdate(activity.ChannelId, activity.Conversation.Id, "API_CHECK", "T");
                            }
                            ...
                            else if (apiActiveText.Equals("접수목록"))
                            {
                                apiIntent = "F_예약확인";
                                db.UserCheckUpdate(activity.ChannelId, activity.Conversation.Id, "API_CHECK", "T");
                            }
                            ...
                            ************************************************************** */
                                        ...
                                        else
                                        {
                                            ...
                                            foreach (JObject jobj in obj)
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    {
                                                        Title = "",
                                                        Text = dateText + "<strong>· 배송상태 : <font color='#0101DF'>" + deliveryStatusText + "</font></strong><br><strong>· 상품명 : </strong><font color='#585858'>" + goodName + "</font><br><strong>· 운송장번호 : <font color='#0101DF'>(" + jobj["wbl_num"].ToString() + ")</font></strong><br><strong>· 보내는 분 : </strong>" + jobj["snd_nam"].ToString(),
                                    ...
                                    foreach (JObject jobj in obj)
                                    {
                                        ...
                                        if (jobj["ret_cod"].ToString().Equals("1000"))
                                        {
                                            ...
                                            if (jobj["wrk_cod"].ToString().Equals("03"))
                                            {
                                                ...
                                                bookCheckText = "· 예약번호 : <strong><font color='#0101DF'>(" + bookNumber + ")</font></strong><br>· 예약상태 : <strong><font color='#0101DF'>예약취소</font></strong><br>· 예약일시 : <strong><font color='#0101DF'>" + dateText1 + "</font></strong><br>· 상품명 : <strong>" + goodName + "</strong><br>· 집배점 : " + orgNam + " ☎ <strong>" + telNum + "</strong><br><br>예약문의 사항은 집배점으로 문의 부탁드립니다";
                                            }
                                            else if (jobj["wrk_cod"].ToString().Equals("11"))
                                            {
                                                ...
                                                bookCheckText = "· 예약번호 : <strong><font color='#0101DF'>(" + bookNumber + ")</font></strong><br>· 예약상태 : <strong><font color='#0101DF'>정상집하</font></strong><br>· 예약일시 : <strong><font color='#0101DF'>" + dateText1 + "</font></strong><br>· 운송장번호 : <strong><font color='#0101DF'>" + jobj["wbl_num"].ToString() + "</font></strong><br>· 상품명 : <strong>" + goodName + "</strong><br>· 집배점 : " + orgNam + " ☎ <strong>" + telNum + "</strong><br><br>예약문의 사항은 집배점으로 문의 부탁드립니다";
                                            }
                                            else
                                            {
                                                String tempDate1 = jobj["wrk_ymd"].ToString();
                                                ...
                                                bookCheckText = "· 예약번호 : <strong><font color='#0101DF'>(" + bookNumber + ")</font></strong><br>· 예약상태 : <strong><font color='#0101DF'>정상예약</font></strong><br>· 예약일시 : <strong><font color='#0101DF'>" + dateText1 + "</font></strong><br>· 상품명 : <strong>" + goodName + "</strong><br>· 집배점 : " + orgNam + " ☎ <strong>" + telNum + "</strong><br><br>방문일정 또는 예약변경 사항, 문의사항은 집배점으로 문의 부탁드립니다";
                                            }
                                        }
                                            ...
                                            else
                                            {
                                                ...
                                                foreach (JObject jobj in obj)
                                                {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        {
                                                            dateText = "";
                                                            cardShowText = "<strong>·예약번호 : </strong><strong><font color='#0101DF'>(" + jobj["rsv_num"].ToString() + ")</font></strong><br><strong>· 상품명 : </strong>" + goodName + " <br><strong>·보내는 분 : </strong>" + jobj["rcv_nam"].ToString() + " <br><strong>·예약상태 : </strong><font color='#0101DF'>" + jobj["wrk_nam"].ToString() + "</font>";
                                                        }
                                                        else
                                                        {
                                                            String yearText = tempDate.Substring(0, 4);
                                                            ...
                                                            cardShowText = "<strong>·예약번호 : </strong><strong><font color='#0101DF'>(" + jobj["rsv_num"].ToString() + ")</font></strong><br><strong>· 상품명 : </strong>" + goodName + " <br><strong>·보내는 분 : </strong>" + jobj["rcv_nam"].ToString() + " <br><strong>·예약상태 : </strong><font color='#0101DF'>" + jobj["wrk_nam"].ToString() + "</font><br><strong>·날짜 : </strong>" + dateText;
                                                        }
                                        ...
                                        */
                                        ...
                                        foreach (JObject jobj in obj)
                                        {
                                            if (jobj["wrk_cod"].ToString().Equals("10"))
                                            {
                                                ...
                                                statusText = "<strong>· 운송장번호 : <font color='#0101DF'>(" + invoiceNumber + ")</font></strong><br>· 배송상태 : <strong><font color='#0101DF'>접수상태</font></strong><br>현재 상품 발송을 위해 운송장이 접수된 상태입니다.<br>터미널 입고 시점부터 배송 일정 조회가 가능하며 당일 출고한 상품은 발송일 오후나 다음날 다시 한번 배송조회 확인해 주시기 바랍니다.<br>1~2일이 경과하여도 상품 이동 내역이 없는 경우에는 주문업체(쇼핑몰) 또는 보내는 분께 상품 발송 일자와 한진택배로 발송된 상품인지 문의해 주시기 바랍니다.";
                                            ...
                                            else if (jobj["wrk_cod"].ToString().Equals("20"))
                                            {
                                                ...
                                                statusText = "<strong>· 운송장번호 : <font color='#0101DF'>(" + invoiceNumber + ")</font></strong><br>· 배송상태 : <strong><font color='#0101DF'>상품발송 대기중</font></strong><br>발송 터미널에 상품이 입고되어 발송대기 중입니다.<br>배송조회 하시는 다음날 다시 한번 확인해 주시기 바랍니다. 지역(현장) 사정에 따라 배송은 1~2일 소요될 수 있는 점 양해바랍니다.";
                                            ...
                                            else if (jobj["wrk_cod"].ToString().Equals("30"))
                                            {
                                                ...
                                                statusText = "<strong>· 운송장번호 : <font color='#0101DF'>(" + invoiceNumber + ")</font></strong><br>· 배송상태 : <strong><font color='#0101DF'>상품이동중</font></strong><br>상품이 발송되어 이동중입니다.<br>배송예정 시간 확인은 당일 도착 물량에 따라 변동이 될 수 있으니 다시 한번 확인 해 주시기 바랍니다. 배송지역 사정에 따라 배송은 1~2일 소요될 수 있는 점 양해바랍니다.";
                                            ...
                                            else if (jobj["wrk_cod"].ToString().Equals("40"))
                                            {
                                                ...
                                                //statusText = "<strong>· 운송장번호 : <font color='#0101DF'>(" + invoiceNumber + ")</font></strong><br>· 배송상태 : <strong><font color='#0101DF'>배송준비중</font></strong><br>배송지역 터미널에 도착하여, 배송 준비중입니다.<br>배송예정 시간 확인은 당일 도착 물량에 따라 변동이 될 수 있으며 배송은 1~2일 소요 될 수 있는 점 양해바랍니다.";
                                                statusText = "<strong>· 운송장번호 : <font color='#0101DF'>(" + invoiceNumber + ")</font></strong><br>· 배송상태 : <strong><font color='#0101DF'>배송준비중</font></strong><br>· 상품명 : <strong>" + goodName + "</strong><br>· 보내는 분 : <strong>" + snd_nam + "</strong><br>· 받는 분 : <strong>" + rcv_nam + "</strong><br>· 집배점 : " + orgNam + " ☎ <strong>" + telNum + "</strong><br><br>배송지역 터미널에 도착하여, 배송 준비중입니다.<br>배송예정 시간 확인은 당일 도착 물량에 따라 변동이 될 수 있으며 배송은 1~2일 소요 될 수 있는 점 양해바랍니다.";
                                            ...
                                            else if (jobj["wrk_cod"].ToString().Equals("50"))
                                            {
                                                ...
                                                //statusText = "<strong>· 운송장번호 : <font color='#0101DF'>(" + invoiceNumber + ")</font></strong><br>· 배송상태 : <strong><font color='#0101DF'>배송중</font></strong><br>· 배송예정시간 : " + delieveryTime + "<br>· 집배점 : " + orgNam + " ☎ <strong>" + telNum + "</strong><br>· 배송직원 : ☎ <strong>" + empTel + "</strong><br>배송예정 시간은 당일 도착 물량에 따라 변동이 될 수 있으며, 배송은 1일에서 2일이 소요 될 수 있는점 양해바랍니다.<br>자세한 문의 사항은 집배점 또는 배송직원에게 확인해주시기 바랍니다.<br>※ 운전중이거나 근무시간이 아닌 경우 통화가 어려울 수 있습니다.";
                                                statusText = "<strong>· 운송장번호 : <font color='#0101DF'>(" + invoiceNumber + ")</font></strong><br>· 배송상태 : <strong><font color='#0101DF'>배송중</font></strong><br>· 배송예정시간 : " + delieveryTime + "<br>· 상품명 : <strong>" + goodNameTemp + "</strong><br>· 보내는 분 : <strong>" + snd_nam + "</strong><br>· 받는 분 : <strong>" + rcv_nam + "</strong><br>· 집배점 : " + orgNam + " ☎ <strong>" + telNum + "</strong><br>· 배송직원 : ☎ <strong>" + empTel + "</strong><br><br>배송예정 시간은 당일 도착 물량에 따라 변동이 될 수 있으며, 배송은 1일에서 2일이 소요 될 수 있는점 양해바랍니다.<br>자세한 문의 사항은 집배점 또는 배송직원에게 확인해주시기 바랍니다.<br>※ 운전중이거나 근무시간이 아닌 경우 통화가 어려울 수 있습니다.";
                                            ...
                                            else if (jobj["wrk_cod"].ToString().Equals("70"))
                                            {
                                                ...
                                                statusText = "<strong>· 운송장번호 : <font color='#0101DF'>(" + invoiceNumber + ")</font></strong><br>· 배송상태 : <strong><font color='#0101DF'>경유중</font></strong><br>현재 배송지역이 아닌 다른 지역에 경유 중으로 배송은 1~2일이 더 소요될 수 있는 점 양해 부탁드립니다.";
                                    ...
                                    if (apiActiveText.Contains("보낸상품배송조회"))
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                wReq = (HttpWebRequest)WebRequest.Create(SendDeliveryList);
                                                wReq.Method = "POST";
                                                wReq.ContentType = "application/x-www-form-urlencoded";
                                                wReq.ContentLength = result.Length;
                                                ...
                                                respPostStream = wResp.GetResponseStream();
                                                readerPost = new StreamReader(respPostStream, Encoding.GetEncoding("ks_c_5601-1987"), true);
                                                String SendDeliveryListJsonData = readerPost.ReadToEnd();
                                                Debug.WriteLine("post data(보낸택배배송목록)====" + SendDeliveryListJsonData);

                                                JArray obj = JArray.Parse(SendDeliveryListJsonData);
                                                ...
                                                else
                                                {
                                                    foreach (JObject jobj in obj)
                                                    {
                                                        if (jobj["ret_cod"].ToString().Equals("9061"))
                                                        {
                                                            totalPage = 1;
                                                            UserHeroCard plCard = new UserHeroCard()
                                                            {
                                                        ...
                                                        else if (jobj["ret_cod"].ToString().Equals("9062"))
                                                        {
                                                            totalPage = 1;
                                                            UserHeroCard plCard = new UserHeroCard()
                                                            {
                                    ...
                                    else if (apiActiveText.Contains("받는상품배송조회"))
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                readerPost = new StreamReader(respPostStream, Encoding.GetEncoding("ks_c_5601-1987"), true);
                                                String DeliveryListJsonData = readerPost.ReadToEnd();
                                                Debug.WriteLine("post data(받는택배배송목록)====" + DeliveryListJsonData);
                            ...
                            if (apiIntent.Equals("F_고객의말씀"))
                            {
                                ...
                                if (mobilePC.Equals("PC"))
                                {
                                    ...
                                    {
                                        Type = "openUrl",
                                        Value = "https://www.hanjin.co.kr/kor/CMS/TotalQuestionMgr/Write1.do?mCode=MN090",
                                        Title = "1:1온라인 상담"
                                    };
                                    addressButtons.Add(addressButton);
                                    ...
                                    {
                                        Title = "",
                                        //Text = "PC 버전은 한진택배 고객의 말씀에서 1:1온라인 상담을 진행합니다.<br>아래버튼을 눌러주세요.",
                                        Text = "네~ 고객님,<br>1:1온라인 상담으로 연결해 드리겠습니다.<br>아래 버튼을 눌러주세요",
                                        Buttons = addressButtons,
                                    };
                                    Attachment plAttachment = addressPlCard3.ToAttachment();
                                    apiMakerReply.Attachments.Add(plAttachment);
                            ...
                            if (apiIntent.Equals("F_자주하는질문"))
                            {
                                ...
                                CardAction guideButton10 = new CardAction();
                                guideButton10 = new CardAction()
                                {
                                    Type = "imBack",
                                    Value = "견적의뢰",
                                    Title = "견적의뢰"
                                };
                                cardButtons.Add(guideButton10);

                                CardAction guideButton11 = new CardAction();
                                guideButton11 = new CardAction()
                                {
                                    Type = "imBack",
                                    Value = "1:1온라인상담",
                                    Title = "1:1온라인상담"
                                };
                                cardButtons.Add(guideButton11);
                                        ...
                                        if (jobj["ret_cod"].ToString().Equals("1000"))
                                        {
                                            ...
                                            * */
                                            if (authUrl.Equals("[F_예약]::택배배송목록"))
                                            {
                                                ...
                                                foreach (JObject jobj1 in obj1)
                                                {
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        {
                                                            Title = "",
                                                            Text = dateText + "<strong>· 배송상태 : <font color='#0101DF'>" + deliveryStatusText + "</font></strong><br><strong>· 상품명 : </strong><font color='#585858'>" + goodName + "</font><br><strong>· 운송장번호 : <font color='#0101DF'>(" + jobj1["wbl_num"].ToString() + ")</font></strong><br><strong>· 보내는 분 : </strong>" + jobj1["snd_nam"].ToString(),
                                                ...
                                                else
                                                {
                                                    ...
                                                    foreach (JObject jobj2 in obj2)
                                                    {
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            {
                                                                dateText = "미할당";
                                                                cardShowText = "<strong>·예약번호 : </strong><strong><font color='#0101DF'>(" + jobj2["rsv_num"].ToString() + ")</font></strong><br><strong>· 상품명 : </strong>" + goodName + " <br><strong>·받는 분 : </strong>" + jobj2["rcv_nam"].ToString() + " <br><strong>·예약상태 : </strong><font color='#0101DF'>" + jobj2["wrk_nam"].ToString() + "</font>";
                                                            }
                                                            else
                                                            {
                                                                String yearText = tempDate.Substring(0, 4);
                                                                ...
                                                                cardShowText = "<strong>·예약번호 : </strong><strong><font color='#0101DF'>(" + jobj2["rsv_num"].ToString() + ")</font></strong><br><strong>· 상품명 : </strong>" + goodName + " <br><strong>·받는 분 : </strong>" + jobj2["rcv_nam"].ToString() + " <br><strong>·예약상태 : </strong><font color='#0101DF'>" + jobj2["wrk_nam"].ToString() + "</font><br><strong>·날짜 : </strong>" + dateText;
                                                            }
                                                ...
                                                else
                                                {
                                                    ...
                                                    foreach (JObject jobj3 in obj3)
                                                    {
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            {
                                                                dateText = "미할당";
                                                                cardShowText = "<strong>·예약번호 : </strong><strong><font color='#0101DF'>(" + jobj3["rsv_num"].ToString() + ")</font></strong><br><strong>· 상품명 : </strong>" + goodName + " <br><strong>·보내는 분 : </strong>" + jobj3["rcv_nam"].ToString() + " <br><strong>·예약상태 : </strong><font color='#0101DF'>" + jobj3["wrk_nam"].ToString() + "</font>";
                                                            }
                                                            else
                                                            {
                                                                String yearText = tempDate.Substring(0, 4);
                                                                ...
                                                                cardShowText = "<strong>·예약번호 : </strong><strong><font color='#0101DF'>(" + jobj3["rsv_num"].ToString() + ")</font></strong><br><strong>· 상품명 : </strong>" + goodName + " <br><strong>·보내는 분 : </strong>" + jobj3["rcv_nam"].ToString() + " <br><strong>·예약상태 : </strong><font color='#0101DF'>" + jobj3["wrk_nam"].ToString() + "</font><br><strong>·날짜 : </strong>" + dateText;
                                                            }
                                            ...
                                            else if (authUrl.Equals("[F_택배배송일정조회]::받는상품배송조회"))
                                            {
                                                ...
                                                Debug.WriteLine("deliveryListPageNum===" + deliveryListPageNum);
                                                WebClient webClient = new WebClient();
                                                ...
                                                readerPost = new StreamReader(respPostStream, Encoding.GetEncoding("ks_c_5601-1987"), true);
                                                String DeliveryListJsonData = readerPost.ReadToEnd();
                                                Debug.WriteLine("post data(인증후택배받는상품목록)====" + DeliveryListJsonData);
                                                ...
                                                else
                                                {
                                                    foreach (JObject jobj4 in obj4)
                                                    {
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            {
                                                                Title = "",
                                                                Text = dateText + "<strong>· 배송상태 : <font color='#0101DF'>" + deliveryStatusText + "</font></strong><br><strong>· 상품명 : </strong><font color='#585858'>" + goodName + "</font><br><strong>· 운송장번호 : <font color='#0101DF'>(" + jobj4["wbl_num"].ToString() + ")</font></strong><br><strong>· 보내는 분 : </strong>" + jobj4["snd_nam"].ToString(),
                                            ...
                                            else if (authUrl.Equals("[F_택배배송일정조회]::보낸상품배송조회"))
                                            {
                                                ...
                                                respPostStream = wResp.GetResponseStream();
                                                readerPost = new StreamReader(respPostStream, Encoding.GetEncoding("ks_c_5601-1987"), true);
                                                String DeliverySendListJsonData = readerPost.ReadToEnd();
                                                Debug.WriteLine("post data(인증후택배보낸상품목록)====" + DeliverySendListJsonData);
                                                JArray obj4 = JArray.Parse(DeliverySendListJsonData);
                                                ...
                                                else
                                                {
                                                    foreach (JObject jobj4 in obj4)
                                                    {
                                                        if (jobj4["ret_cod"].ToString().Equals("9061"))
                                                        {
                                                            totalPage = 1;
                                                            plCard = new UserHeroCard()
                                                            {
                                                        ...
                                                        else if (jobj4["ret_cod"].ToString().Equals("9062"))
                                                        {
                                                            totalPage = 1;
                                                            plCard = new UserHeroCard()
                                                            {
